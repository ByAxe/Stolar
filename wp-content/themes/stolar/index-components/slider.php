    ...
    <div id="carousel-example-generic" class="carousel slide" data-ride="carousel" data-pause="hover"
        ...
        <div class="carousel-inner textInSlider">
            <div class="item active">
                <img src="<?php bloginfo('template_url'); ?>/images/slider/img_1.png" alt="Image">
            ...
            <div class="item">
                <img src="<?php bloginfo('template_url'); ?>/images/slider/img_2.png" alt="Image">
                <div class="carousel-caption">
                    <h3>Дачи и Дома</h3>
            ...
            <div class="item">
                <img src="<?php bloginfo('template_url'); ?>/images/slider/img_3.png" alt="Image">
                <div class="carousel-caption">
                    <h3>Антресоли</h3>
            ...
            <div class="item">
                <img src="<?php bloginfo('template_url'); ?>/images/slider/img_4.png" alt="Image">
                <div class="carousel-caption">
                    <h3>Мебель и Окна</h3>
            ...
            <div class="item">
                <img src="<?php bloginfo('template_url'); ?>/images/slider/img_5.png" alt="Image">
                <div class="carousel-caption">
            ...
            <div class="item">
                <img src="<?php bloginfo('template_url'); ?>/images/slider/img_6.png" alt="Image">
                <div class="carousel-caption">
            ...
            <div class="item">
                <img src="<?php bloginfo('template_url'); ?>/images/slider/img_7.png" alt="Image">
                <div class="carousel-caption">
            ...
            <div class="item">
                <img src="<?php bloginfo('template_url'); ?>/images/slider/img_8.png" alt="Image">
                <div class="carousel-caption">
                    <h3>Утепление</h3>
            ...
            <div class="item">
                <img src="<?php bloginfo('template_url'); ?>/images/slider/img_9.png" alt="Image">
                <div class="carousel-caption">
                    <h3>Лестницы</h3>
            ...
            <div class="item">
                <img src="<?php bloginfo('template_url'); ?>/images/slider/img_10.png" alt="Image">
                <div class="carousel-caption">
